						...
						>
							<span className="flex items-center">
								{selectedValue ? (
									<>
										{token ? (
											<Token token={selectedValue as TokenModel} size={24} />
										) : flag ? (
											<Flag name={countries[selectedValue.icon!]} size={24} />
										) : (
											!!selectedValue.icon && (
												<Image
									...
									<span className={`${minimal ? 'ml-1' : 'ml-3'} block truncate text-gray-500`}>
										Select
									</span>
								)}
							</span>
